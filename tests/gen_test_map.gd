...
##   (2,5) magenta -> sand lurker (MILESTONE_9.md)
##   (6,5) cyan    -> spitter (MILESTONE_9.md)
##   (3,8) grey    -> wreckage
func _write_generation_layer() -> void:
	...
	img.set_pixel(2, 5, Color(1, 0, 1))       # #FF00FF sand lurker
	img.set_pixel(6, 5, Color(0, 1, 1))       # #00FFFF spitter
